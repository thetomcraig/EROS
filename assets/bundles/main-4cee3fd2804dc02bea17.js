...
var triangle1 = paper.polygon(start_points[0], start_points[1], start_points[2], start_points[3], center.x, center.y, fill);
var triangle2 = paper.polygon(start_points[2], start_points[3], start_points[4], start_points[5], center.x, center.y);
var triangle3 = paper.polygon(start_points[4], start_points[5], start_points[6], start_points[7], center.x, center.y);
var triangle4 = paper.polygon(start_points[6], start_points[7], start_points[0], start_points[1], center.x, center.y);
