...
var paper = Snap('svg');
var start_points = [a.x + 50 * Math.sqrt(2), 50 * Math.sqrt(2) - a.y, b.x + 50 * Math.sqrt(2), 50 * Math.sqrt(2) - b.y, c.x + 50 * Math.sqrt(2), 50 * Math.sqrt(2) - c.y, d.x + 50 * Math.sqrt(2), 50 * Math.sqrt(2) - d.y];
var end_points = [0, 0, 50 * Math.sqrt(2), 0, 50 * Math.sqrt(2), 50 * Math.sqrt(2), 0, 50 * Math.sqrt(2)];
