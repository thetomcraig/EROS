...
var Snap = __webpack_require__(85);
...
var paper = Snap(percentage_multiplier * 2 + buffer, percentage_multiplier * 2 + buffer);
...
var start_points = [a.x + translation, translation - a.y, b.x + translation, translation - b.y, c.x + translation, translation - c.y, d.x + translation, translation - d.y];
var end_points = [a.x * scalar + translation, translation - a.y * scalar, b.x * scalar + translation, translation - b.y * scalar, c.x * scalar + translation, translation - c.y * scalar, d.x * scalar + translation, translation - d.y * scalar];
...
var triangle0_start_points = [start_points[0], start_points[1], start_points[2], start_points[3], center.x, center.y];
var triangle0_end_points = [start_points[0] * scalar, start_points[1] * scalar, start_points[2] * scalar, start_points[3] * scalar, center.x, center.y];
var triangle0 = paper.polygon(triangle0_start_points);
triangle0.attr({
    fill: colors[0]
});
var triangle1_start_points = [start_points[2], start_points[3], start_points[4], start_points[5], center.x, center.y];
var triangle1_end_points = [start_points[2] * scalar, start_points[3] * scalar, start_points[4] * scalar, start_points[5] * scalar, center.x, center.y];
var triangle1 = paper.polygon(triangle1_start_points);
triangle1.attr({
    fill: colors[1]
});
var triangle2_start_points = [start_points[4], start_points[5], start_points[6], start_points[7], center.x, center.y];
var triangle2_end_points = [start_points[4] * scalar, start_points[5] * scalar, start_points[6] * scalar, start_points[7] * scalar, center.x, center.y];
var triangle2 = paper.polygon(triangle2_start_points);
triangle2.attr({
    fill: colors[2]
});
var triangle3_start_points = [start_points[6], start_points[7], start_points[0], start_points[1], center.x, center.y];
var triangle3_end_points = [start_points[6] * scalar, start_points[7] * scalar, start_points[0] * scalar, start_points[1] * scalar, center.x, center.y];
...
function animationIn() {
    if (animating) {
        polygon.animate({ "points": start_points }, 1000, mina.elastic, animationOut);
        triangle0.animate({ "points": triangle0_start_points }, 1000, mina.elastic, animationOut);
        triangle1.animate({ "points": triangle1_start_points }, 1000, mina.elastic, animationOut);
        triangle2.animate({ "points": triangle2_start_points }, 1000, mina.elastic, animationOut);
        triangle3.animate({ "points": triangle3_start_points }, 1000, mina.elastic, animationOut);
    };
}
function animationOut() {
    polygon.animate({ "points": end_points }, 250, mina.linear, animationIn);
    triangle0.animate({ "points": triangle0_end_points }, 1000, mina.linear, animationIn);
    triangle1.animate({ "points": triangle1_end_points }, 1000, mina.linear, animationIn);
    triangle2.animate({ "points": triangle2_end_points }, 1000, mina.linear, animationIn);
    triangle3.animate({ "points": triangle3_end_points }, 1000, mina.linear, animationIn);
}

// Do the do
polygon.hover(function () {
    animating = true;animationIn();
}, function () {
    animating = false;
});
triange0.hover(function () {
    animating = true;animationIn();
}, function () {
    animating = false;
});
triange1.hover(function () {
    animating = true;animationIn();
}, function () {
    animating = false;
});
triange2.hover(function () {
    animating = true;animationIn();
}, function () {
    animating = false;
});
triange3.hover(function () {
    animating = true;animationIn();
}, function () {
    animating = false;
});
