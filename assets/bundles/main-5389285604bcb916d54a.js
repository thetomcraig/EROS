...
var end_points = [Math.round(100 * percentage_multiplier), Math.round(100 * percentage_multiplier), Math.round(100 * percentage_multiplier), Math.round(100 * percentage_multiplier)];
...
end_func = function () {
    start_polygon.animate({ "points": end_points.toString() }, 1000, mina.linear);
};
