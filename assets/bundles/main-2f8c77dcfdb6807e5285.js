...
var end_points = [0, 0, 100, 0, 100, 100, 0, 100];
...
function animationIn() {
    if (animating) {
        start_polygon.animate({ "points": start_points }, 1000, mina.linear, animationOut);
    }
}
function animationOut() {
    start_polygon.animate({ "points": start_points }, 1000, mina.linear, animationIn);
}
