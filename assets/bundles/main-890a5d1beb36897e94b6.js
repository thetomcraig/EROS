...
s.polygon(a.x + 100, 100 - a.y, b.x + 100, 100 - b.y, c.x + 100, 100 - c.y, d.x + 100, 100 - d.y).attr({ fill: "red", stroke: "blue" });

var paper = Snap('svg');
var start_points = [a.x + 100, 100 - a.y, b.x + 100, 100 - b.y, c.x + 100, 100 - c.y, d.x + 100, 100 - d.y];
var end_points = [100 * percentage_multiplier, 100 * percentage_multiplier, 100 * percentage_multiplier, 100 * percentage_multiplier];
var start_polygon = paper.polygon(start_points);
start_polygon.attr({
    id: "tri",
    fill: "#555555"
});
...
start_func = function () {
    start_polygon.animate({ "points": start_points }, 1000, mina.linear);
};
end_func = function () {
    start_polygon.animate({ "points": end_points }, 1000, mina.linear);
};
setTimeout(start_func, 200);
setTimeout(end_func, 1200);
