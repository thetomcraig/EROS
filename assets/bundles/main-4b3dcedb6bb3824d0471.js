...
var triangle0_end_points = [end_points[0], end_points[1], end_points[2], end_points[3], center.x, center.y];
...
var triangle1_end_points = [end_points[2], end_points[3], end_points[4], end_points[5], center.x, center.y];
...
var triangle2_end_points = [end_points[4], end_points[5], end_points[6], end_points[7], center.x, center.y];
...
var triangle3_end_points = [end_points[6], end_points[7], end_points[0], end_points[1], center.x, center.y];
