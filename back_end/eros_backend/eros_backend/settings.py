"""
Django settings for eros_backend project.
...
from eros_backend import local_settings
...
ROOT_URLCONF = 'eros_backend.urls'
...
WSGI_APPLICATION = 'eros_backend.wsgi.application'
