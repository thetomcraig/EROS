...
function animationOut() {
    ...
    triangle0.animate({ "points": triangle0_end_points }, 1000, mina.elastic, animationOut);
    triangle1.animate({ "points": triangle1_end_points }, 1000, mina.elastic, animationOut);
    triangle2.animate({ "points": triangle2_end_points }, 1000, mina.elastic, animationOut);
    triangle3.animate({ "points": triangle3_end_points }, 1000, mina.elastic, animationOut);
}
