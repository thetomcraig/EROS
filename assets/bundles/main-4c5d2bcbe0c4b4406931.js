...
var top_left = { x: -percentage_multiplier + translation * scalar, y: (translation - percentage_multiplier) * scalar };
var top_right = { x: percentage_multiplier + translation * scalar, y: (translation - percentage_multiplier) * scalar };
var bottom_right = { x: percentage_multiplier + translation * scalar, y: (translation + percentage_multiplier) * scalar };
var bottom_left = { x: -percentage_multiplier + translation * scalar, y: (translation + percentage_multiplier) * scalar };
...
var end_points = [top_left.x, top_left.y, top_right.x, top_right.y, bottom_right.x, bottom_right.y, bottom_left.x, bottom_left.y];
...
function animationOut() {
    polygon.animate({ "points": end_points }, 1000, mina.elastic, animationIn);
}
