...
var end_points = [50 * Math.sqrt(2), 50 * Math.sqrt(2), 2 * 50 * Math.sqrt(2), 50 * Math.sqrt(2), 0, 2 * 50 * Math.sqrt(2), 2 * 50 * Math.sqrt(2), 50 * Math.sqrt(2), 2 * 50 * Math.sqrt(2)];
...
var center_circle = paper.circle(translation, translation, 5);
center_circle.attr({ 'fill': 'red' });
var top_left = paper.circle(-percentage_multiplier + translation, translation - percentage_multiplier, 5);
var top_right = paper.circle(percentage_multiplier + translation, translation - percentage_multiplier, 5);
var bottom_right = paper.circle(percentage_multiplier + translation, translation + percentage_multiplier, 5);
bottom_right.attr({
    fill: "blue"
});
var bottom_left = paper.circle(-percentage_multiplier + translation, translation + percentage_multiplier, 5);
