...
from integrations import twitter_views

urlpatterns = [
    url(r'^twitter_home', twitter_views.twitter_home, name='twitter_home'),
    url(r'^instagram_home', integrations_views.instagram_home, name='instagram_home'),
    url(r'^tinder_home', integrations_views.tinder_home, name='tinder_home'),

    url(r'^twitter_person_detail/(?P<person_username>[a-zA-Z0-9]+[\w|\W]+)/$',
        twitter_views.twitter_person_detail, name='twitter_person_detail'),
    ...
    url(r'^twitter_conversation/(?P<person_username>\w+)/(?P<partner_username>\w+)/$', twitter_views.twitter_conversation, name='twitter_conversation'),
